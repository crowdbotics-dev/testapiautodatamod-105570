...
## Project Structure
    ...
    ├── testapiautodatamod_105570  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_105570`
...
2. Clone this repo and `cd testapiautodatamod_105570`
